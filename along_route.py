...
def setup_agent(vehicle, destination):
    """
    Setup the BasicAgent for the vehicle and set its destination.
    """
...
def main():
    ...
    agent = setup_agent(vehicle, point_b)
...
if __name__ == '__main__':
 ...
 #why agent instead of autopiolot :https://carla.readthedocs.io/en/latest/adv_agents/#implement-an-agent
